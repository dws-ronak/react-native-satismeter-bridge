...
public class SatismeterBridgeModule extends ReactContextBaseJavaModule {
  public static final String NAME = "SatismeterBridge";
  private final ReactApplicationContext reactContext;

  public SatismeterBridgeModule(ReactApplicationContext reactContext) {
    super(reactContext);
